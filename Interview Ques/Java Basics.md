...
59. The program throws a compile-time error? State the reason and number of errors it will throw. 
...
60.	Predict the output of the code snippet
...
61. What should be in Line 4 to get the output 97?
...
62. Predict the output of the following code snippet
...
64.	Predict the output of the following output.
...
65. How many times the output 'Have a nice day' will be printed?
...
66. How many times the output 'Good Day' will be printed?
...
67. Write the for loop statement in Line 4 to declare infinitive loop
...
68. Can you find out the error in the below code?
...
69. Predict the error in the following code snippet.
...
70. Predict the error in the following code snippet.
...
71. Mr.XYZ has written the code like below but it is showing compile time error. Can you help him to remove the error?
